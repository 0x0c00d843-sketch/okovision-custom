...
$(document).ready(function() {
	...
	function generer_synthese_saison() {
		...
		$.api('GET', 'rendu.getTotalSaison', {
				...
				$("#djuSaison").text(DecSepa(((json.dju === null) ? 0 : json.dju) + ""));
				$("#djmoySaison").text(DecSepa(((json.djmoy === null) ? 0 : json.djmoy) + ""));
				$("#djeSaison").text(DecSepa(((json.dje === null) ? 0 : json.dje) + ""));
		...
		$.api('GET', 'rendu.getSyntheseSaisonTable', {
				...
				$.each(json, function(key, val) {
                    $('#recap > tbody:last').append('<tr> \
            											<td>'+ val.mois +'</td> \
        	                                            <td>'+ val.nbCycle +'</td> \
        	                                            <td>'+ val.dureeMoyComb +' min</td> \
        	                                            <td>'+ val.dureeMoyCycle +' min</td> \
        	                                            <td>'+ val.dju +'</td> \
        	                                            <td>'+ val.djmoy +'</td> \
        	                                            <td>'+ val.dje +'</td> \
														<td>'+ val.conso +' Kg</td> \
														<td>'+ val.conso_ecs +' Kg</td> \
        	                                            <td>'+ val.g_dju_m +'</td> \
        	                                            <td>'+ val.g_djmoy_m +'</td> \
        	                                            <td>'+ val.g_dje_m +'</td> \
        	                                          </tr>');
